...
def main(argv=None):
    ...
    group.add_option("--knee-method",
                     dest="knee_method",
                     choices=["distance", "density","None"],
                     help=("Use distance or density or None methods for detection of knee"))
    group.add_option("--expect-cells",
                     dest="expect_cells",
                     type="int",
                     help=("Prior expectation on the upper limit on the "
                           "number of cells sequenced"))
    group.add_option("--expect-count",
                     dest="expect_count",
                     type="int",
                     help=("Prior expectation on the lower limit of the "
                           "number of reads/umi count"))
